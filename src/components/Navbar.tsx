  ...
  return (
    <div className="flex items-center space-x-2">
      ...
      <div className="hidden sm:flex flex-col">
        <span className="text-sm font-bold text-black leading-tight tracking-tight">
          KIRK&apos;S PITCHING
        </span>
        <span className="text-xs text-gray-500 leading-tight tracking-wide uppercase">
          Performance
        </span>
      </div>
    </div>
...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-white/98 backdrop-blur-md border-b border-gray-100">
          ...
          <div className="px-4 py-4 space-y-3">
            ...
            <div className="pt-3 border-t border-gray-100 space-y-3">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="block w-full text-center bg-red-600 hover:bg-red-700 text-white font-semibold px-4 py-3 rounded-md transition-colors"
              >
                Book a Call
              </a>
              <a
              ...
              >
                ...
                <span>@kirkspitchingperformance</span>
              </a>
            </div>
          </div>
        </div>
