      ...
      <section className="py-10 md:py-16 bg-white">
        <div className="max-w-[1150px] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              { before: 78, after: 87, name: 'Jake M.', type: 'High School RHP', duration: '6 Month Program', desc: 'Came in as a junior throwing 78. Left touching 87 and earned a D2 scholarship. Focus was on hip-shoulder separation and arm path efficiency.' },
              { before: 84, after: 91, name: 'Marcus T.', type: 'College LHP', duration: 'Remote Program', desc: 'Division III starter who needed more velocity to compete. Remote training over 8 months resulted in 7 mph gain and a conference-leading ERA.' },
              { before: 68, after: 75, name: 'Tommy R.', type: '14U Travel Ball', duration: '4 Month Program', desc: 'Young arm with great work ethic. Built a foundation of proper mechanics and arm care that will serve him for years. Gained 7 mph safely.' },
              { before: 88, after: 94, name: 'Chris D.', type: 'JUCO RHP', duration: 'In-Person Training', desc: 'Transfer portal candidate who needed to stand out. Combination of weighted balls, strength work, and mechanical refinement unlocked 6 mph.' },
