      ...
      <section className="py-10 md:py-16 bg-white">
        <div className="max-w-[1150px] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              { before: 84, after: 91, name: 'Chase Geiser', type: 'College RHP', duration: '6 Month Program', desc: 'Came in as a junior throwing 78. Left touching 87 and earned a D2 scholarship. Focus was on hip-shoulder separation and arm path efficiency.' },
              { before: 75, after: 86, name: 'Tovi Salzman.', type: 'College LHP', duration: '6 Month Program', desc: 'Division III starter who needed more velocity to compete. Remote training over 8 months resulted in 7 mph gain and a conference-leading ERA.' },
